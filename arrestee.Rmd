...
```{r arresteeCrime, fig.cap = "The number and percent of crimes reported from all agencies in 2019, by crime category."}
...
```{r GrouBarresteeCrime, fig.cap = "The number and percent of crimes reported from all agencies in 2019, by crime category."}
...
```{r arresteeWeapon, fig.cap = "The bias motivation (i.e. if hate crime or not) for all arrestees reported in 2019."}
...
```{r arresteeWeaponArmed, fig.cap = "The bias motivation (i.e. if hate crime or not) for all arrestees reported in 2019."}
