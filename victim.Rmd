...
```{r victimResidenceStatusIndividual, fig.cap = "The distribution of residence status for all Individual (i.e. person who is not law enforcement officer) victims."}
victim %>%
