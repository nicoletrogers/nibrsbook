...
knitr::kable(temp, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The number and percent of property stolen (including forcibly taken such as during a robbery) in a crime, for all offenses in 2019. Each incident can have multiple items stolen.") %>%
...
knitr::kable(temp, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The number and percent of property seized by police (excludes recovering property that was stolen, for all offenses in 2019. Each incident can have multiple items seized.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
...
knitr::kable(temp, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The number and percent of drugs seized by police by type of drug, for all drugs seized in 2019.") %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE, latex_options = c("hold_position", "repeat_header"))
```
