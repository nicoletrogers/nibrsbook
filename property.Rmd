...
knitr::kable(temp, 
             ...
             longtable = TRUE,
             escape = FALSE,
             caption = "The number and percent of property lost, including property stolen (including forcibly taken such as during a robbery) in a crime, burned in an arson, or seized by police (generally in drug arrests), for all offenses in 2019. Each offense can have multiple items stolen/seized.") %>%
