...
```{r propertyDescription, fig.cap = "The number and percent of property stolen (including forcibly taken such as during a robbery) in a crime or seized by police (generally in drug arrests) for all offenses in 2019. Each offense can have multiple items stolen/seized."}
...
```{r propertyDaysUntilRecovered, fig.cap = "The distribution of the number of days from the incident to the property recovered date. In 2019 the maxiumum days from incident to arrest was 450 days. Zero days means that the arrest occurred on the same day as the incident. "}
...
```{r propertyDrugs, fig.cap = "The number and percent of drugs seized by police by type of drug."}
temp <- make_frequency_table(property,
