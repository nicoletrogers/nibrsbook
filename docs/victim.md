...
\caption{The distribution of residence status for all Individual (i.e. person who is not law enforcement officer) victims.}(\#fig:victimResidenceStatusIndividual)
\end{figure}
