...
\caption{The percent of crime incidents in 2019 NIBRS by the month of incident.}(\#fig:administrativeIncidentMonth)
\end{figure}
...
\caption{The percent of crimes that occur (the day of the incident, even if the crime wasn't reported that day) each day of the month for all agencies reporting to NIBRS in 2019.}(\#fig:administrativeMonthDayIncident)
\end{figure}
...
\caption{The distrubtion of exceptional clearances for all exceptional clearances reported to NIBRS in 2019.}(\#fig:administrativeExceptionalClearances)
\end{figure}
...
\caption{The distribution for the number of Offender Segments per incident, for all incidents in NIBRS 2019.}(\#fig:administrativeOffenseSegments)
\end{figure}
...
\caption{The distribution for the number of Offender Segments per incident, for all incidents in NIBRS 2019.}(\#fig:administrativeOffenderSegments)
\end{figure}
...
\caption{The distribution for the number of Victim Segments per incident, for all incidents in NIBRS 2019.}(\#fig:administrativeVictimSegments)
\end{figure}
...
\caption{The distribution for the number of Arrestee Segments per incident, for all incidents in NIBRS 2019.}(\#fig:administrativeArresteeSegments)
\end{figure}
