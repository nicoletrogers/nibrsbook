...
\caption{The distrubtion of exceptional clearances for all exceptional clearances reported to NIBRS in 2019.}\label{fig:administrativeExceptionalClearances}
\end{figure}
