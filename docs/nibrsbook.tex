...
\textbackslash begin\{center\}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-3-1}
...
\textbackslash begin\{center\}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-7-1}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-8-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-9-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\textbackslash begin\{center\}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-11-1}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-12-1} \end{center}

\hypertarget{age-1}{%
\subsection{Age}\label{age-1}}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-13-1} \end{center}

\hypertarget{sex-1}{%
\subsection{Sex}\label{sex-1}}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-14-1} \end{center}

\hypertarget{race-1}{%
\subsection{Race}\label{race-1}}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-15-1} \end{center}

\hypertarget{ethnicity}{%
\subsection{Ethnicity}\label{ethnicity}}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-7-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/propertyValuePropertyLevel-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/propertyValueIncidentLevel-1} \end{center}
...
\textbackslash begin\{center\}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/unnamed-chunk-6-1}
...
\begin{center}\includegraphics[width=0.9\linewidth]{nibrsbook_files/figure-latex/propertyAllGramMeasures-1} \end{center}
