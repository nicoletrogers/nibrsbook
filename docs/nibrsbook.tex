...
\caption{The distribution in the number of premises entered during burglaries. This info is only available for a very small subset of burglaries.}\label{fig:offensePremisesEntered}
\end{figure}
...
\begin{longtable}[]{@{}lrr@{}}
\caption{\label{tab:offenseBiasMotivation}The number and percent of offenders that had a bias motivataion or not for all offenses reported in 2019.}\tabularnewline
\toprule
