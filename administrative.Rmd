...
```{r administrativeMonthDay, fig.cap = "The percent of crimes that are reported each day of the month for all agencies reporting to NIBRS in 2019."}
...
ggplot2::ggplot(administrative, aes(x = mday)) + 
  theme_crim() + 
  ggplot2::coord_flip() +
...
```{r administrativeMonthDayReport, fig.cap = "The percent of crimes that are reported each day of the month for all agencies reporting to NIBRS in 2019."}
...
```{r administrativeHours, fig.cap = "The percent of crimes that are reported each hour for all agencies reporting to NIBRS in 2019."}
