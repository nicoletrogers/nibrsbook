...
```{r administrativeIncidentMonth, fig.cap = "The percent of crime incidents in 2019 NIBRS by the month of incident."}
...
```{r administrativeMonthDay1, fig.cap = "The percent of crimes that occur (the day of the incident, even if the crime wasn't reported that day) each day of the month for all agencies reporting to NIBRS in 2019.", fig.height=11}
...
```{r administrativeMonthDayReport, fig.cap = "The percent of crimes that are reported (the day of the report, even if not the day of the incident) each day of the month for all agencies reporting to NIBRS in 2019.", fig.height=11}
...
```{r administrativeHours, fig.cap = "The percent of crimes that are reported each hour for all agencies reporting to NIBRS in 2019.", fig.height=11}
...
```{r administrativeExceptionalClearances, fig.cap = "The distrubtion of exceptional clearances for all exceptional clearances reported to NIBRS in 2019."}
...
```{r administrativeOffenseSegments, fig.cap = "The distribution for the number of Offender Segments per incident, for all incidents in NIBRS 2019."}
...
```{r administrativeOffenderSegments, fig.cap = "The distribution for the number of Offender Segments per incident, for all incidents in NIBRS 2019."}
...
```{r administrativeVictimSegments, fig.cap = "The distribution for the number of Victim Segments per incident, for all incidents in NIBRS 2019."}
...
```{r administrativeArresteeSegments, fig.cap = "The distribution for the number of Arrestee Segments per incident, for all incidents in NIBRS 2019."}
...
percent_arrested$total_offender_segments_temp[percent_arrested$total_offender_segments_temp %in% 10:81] <- "10 or more"
percent_arrested <-
  percent_arrested %>%
  group_by(total_offender_segments_temp) %>%
...
percent_arrested$total_offender_segments_temp <- factor(percent_arrested$total_offender_segments_temp, levels = c(1:9, "10 or more"))
